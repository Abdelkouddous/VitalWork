...
const ROLE_CONFIGS = {
  clinic: {
    ...
    demoEmail: "employer1@vitalwork.dz",
    fallbackEmail: "employer@vitalwork.com",
  ...
  jobseeker: {
    ...
    demoEmail: "seeker1@vitalwork.dz",
    fallbackEmail: "jobseeker@vitalwork.com",
    demoPassword: "password123",
  ...
  admin: {
    ...
    fallbackEmail: "admin@vitalwork.com",
    demoPassword: "password123",
    registerLink: null,
    forgotPasswordLink: "/forgot-password",
  },
